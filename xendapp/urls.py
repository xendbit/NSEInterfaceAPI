...
urlpatterns = [
    # path('assets/new-user', artexchange_views.user_registration, name='artuser_registration'),
    path('auth/users', auth_views.UserList.as_view() , name='signup'),
    ...
    path('assets/buy-request', assets_views.asset_buy_request, name='buy_request'),
    path('assets/listing', assets_views.asset_listing, name='listing'),
]